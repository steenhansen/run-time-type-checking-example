The Run-Time-Type-Checking-Example web page, [https://run-time-type-checking.herokuapp.com/](https://run-time-type-checking.herokuapp.com/) a free slow to start, a [vite-plugin-ssr](https://vite-plugin-ssr.com/) project, exists to highlight the use of the
